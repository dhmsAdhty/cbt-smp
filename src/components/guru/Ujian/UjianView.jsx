                    ...
                    <AnimatePresence>
                        {filteredUjians.map((ujian) => (
                            <motion.div
                                ...
                                className="bg-white rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300 flex flex-col"
                            >
                                {/* Card Header */}
                                ...
                                <div className="p-4 flex-1">
                                    ...
                                    <div className="space-y-2 text-sm text-gray-500 bg-gray-50 p-3 rounded-xl">
                                        <div className="flex items-center gap-2">
                                            <Calendar02Icon size={15} className="text-blue-500 flex-shrink-0" />
                                            <span className="text-xs truncate">
                                                <span className="font-medium text-gray-600">Mulai:</span>{' '}
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs truncate">
                                                <span className="font-medium text-gray-600">Selesai:</span>{' '}
