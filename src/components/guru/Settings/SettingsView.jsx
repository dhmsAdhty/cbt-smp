                            ...
                            <div className="grid grid-cols-1 gap-4">
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Siswa wajib menggunakan mode layar penuh selama ujian</p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-800 dark:text-white text-sm">Cegah Split Screen</h3>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Blokir ujian jika ukuran layar terdeteksi mengecil</p>
                                        </div>
                                    </div>
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Nonaktifkan fitur copy, paste, dan klik kanan</p>
                                        </div>
                                    </div>
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input
